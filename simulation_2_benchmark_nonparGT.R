...
names_database = list.files(paste("./results/data_simulation_",n,sep = ""), pattern = "*.mat",full.names = TRUE)
names_query = list.files(paste("./results/example_",n,sep = ""), pattern = "*.mat",full.names = TRUE)
...
write.matrix(distance_all, file = paste("./results/comparison2_non_R_",n,example,"1.csv",sep = ""))
write.matrix(truth_label, file = paste("./results/truth_label2_R_",n,example,"1.csv",sep = ""))
write.matrix(time_query, file = paste("./results/time_query2_R_",n,example,"1.csv",sep = ""))
