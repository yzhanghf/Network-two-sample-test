...
% 				sparsity_parameters_b ^(-s)*sparsity_parameters_b ^s *mu_n;
			...
			writematrix(coverage,strcat("./new-result/MC_t_cover_edge_",string(m),"_",string(n),"_",MotifName,"_",GraphonName1,"_",GraphonName2,"_mn.csv"))
			writematrix(coverage2,strcat("./new-result/MC_t_cover_norm_",string(m),"_",string(n),"_",MotifName,"_",GraphonName1,"_",GraphonName2,"_mn.csv"))
			writematrix(t_mc,strcat("./new-result/MC_t_",string(m),"_",string(n),"_",MotifName,"_",GraphonName1,"_",GraphonName2,"_mn.csv"))
		end
	end % end for n
	fprintf('\n\n');
end