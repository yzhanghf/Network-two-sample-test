    ...
    for mf = 1:length(MotifNameall)
        for k = 1:length(N)
            for l = 1:length(N)
                ...
                cover = readtable(strcat("./new-result-test-power/cover_edge_",...
                ...
                cover = readtable(strcat("./new-result-test-power/cover_norm_",...
                    MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                    "100shift_",sprintf('%03d',100*shift_amount),...
                    "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
                ...
                cover = readtable(strcat("./new-result-test-power/cover_netcomp_",...
                MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                "100shift_",sprintf('%03d',100*shift_amount),...
                "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
                ...
                cover = readtable(strcat("./new-result-test-power/cover_netlsd_",...
                MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                "100shift_",sprintf('%03d',100*shift_amount),...
                "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
                ...
                cover = readtable(strcat("./new-result-test-power/cover_nonparGT_",...
                MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                "100shift_",sprintf('%03d',100*shift_amount),...
                "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
                ...
                cover = readtable(strcat("./new-result-test-power/cover_resample_",...
                MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                "100shift_",sprintf('%03d',100*shift_amount),...
                "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
                ...
                cover = readtable(strcat("./new-result-test-power/cover_subsample_",...
                MotifName,"_",GraphonName1,"_",GraphonName2,"_",...
                "100shift_",sprintf('%03d',100*shift_amount),...
                "m_", string(m), "n_", string(n),".csv"));
                cover = table2array(cover);
...
if(shift_amount > 0.0001)
    fig = figure("visible","off");
        ...
        % % Create portions array for interpolating colors
        % portions = (0:(half_mm - 1)) / half_mm;
        % portions = portions(:);

        % % Define darker shades of orange and green
        % dark_orange = [0.8, 0.4, 0]; % Darker orange
        % dark_green = [0, 0.8, 0];    % Darker green

        % % Construct the colormap
        % % Transition from dark orange to white for negative values
        % % Then from white to dark green for positive values
        % cmp = [...
        %     (1 - portions) * dark_orange + portions * [1 1 1]; ...  % Dark Orange to White
        %     [1 1 1]; ...                                            % White
        %     portions * dark_green + (1 - portions) * [1 1 1]; ...   % White to Dark Green
        % ];
