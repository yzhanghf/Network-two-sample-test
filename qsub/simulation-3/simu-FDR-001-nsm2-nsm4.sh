...
matlab -r "graphon_shift = 0.01;GraphonName1='NewSmoothGraphon2';GraphonName2='NewSmoothGraphon4';sparsity_parameters_a=1.0;sparsity_parameters_b=1.0;simulation_3_all"
