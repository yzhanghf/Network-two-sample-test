...
rec(:,1) = minmaxp;
rec(:,2) = Truthind;
writematrix(rec,strcat("./ROC_result/minpv_truth_nores_",example,string(n),".csv"));
writematrix(elapsedTime,strcat("./ROC_result/querytime_pval_nores_",example,string(n),".csv"));
writematrix(auc_r,strcat("./ROC_result/auc_pval_nores_",example,string(n),".csv"));
