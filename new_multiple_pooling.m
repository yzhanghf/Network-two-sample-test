...
% 				sparsity_parameters_b ^(-s)*sparsity_parameters_b ^s *mu_n;
			...
			writematrix(coverage,	strcat("./new-result-2-multiple-pooling/cover_edge_",	MotifName,"_",GraphonName1,"_",GraphonName2,	"shift_", string(100*shift_amount),    "NA_",string(Na), "NB_",string(Nb), "_mn_",string(m),".csv"))
			writematrix(coverage2,	strcat("./new-result-2-multiple-pooling/cover_norm_",	MotifName,"_",GraphonName1,"_",GraphonName2,	"shift_", string(100*shift_amount),    "NA_",string(Na), "NB_",string(Nb), "_mn_",string(m),".csv"))
			writematrix(t_mc,		strcat("./new-result-2-multiple-pooling/teststat_",		MotifName,"_",GraphonName1,"_",GraphonName2,	"shift_", string(100*shift_amount),    "NA_",string(Na), "NB_",string(Nb), "_mn_",string(m),".csv"))
		end
	end % end for n
	fprintf('\n\n');
end
